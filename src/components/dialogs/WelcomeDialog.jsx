  ...
  return (
    <Dialog isOpen={isWelcome} toggleClose={toggleWelcome}>
      <div className="mx-5 flex flex-col items-center p-3 text-center">
        ...
        <div className="my-1 flex w-2/3 flex-row items-center justify-evenly rounded border-2 py-3">
          <p>{`Check out our project on GitHub!`}</p>
          <a
            href="https://github.com/vanfossen/ftir-sis-rework"
            target="_blank"
            className="m-0 cursor-pointer rounded-full p-0 hover:*:fill-orange-500"
          >
            <svg width="35" viewBox="0 0 98 96" fill="currentColor">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
